Git is a popular version control system used to manage the code of collaborative projects. GitHub is a platform that works with Git to store project code in the cloud and easily collaborate with teams.
